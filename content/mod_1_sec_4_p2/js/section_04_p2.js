...
b4w.register("section_04_p2", function(exports, require) {
...
var s04q01_lift = new Audio('audio/s04q01_lift.mp3');
 ...
 */
function load() {
  m_data.load("mod_1_sec_4_p2.json", load_cb, function(percent, load_time) {
...
function load_cb(data_id) {
  ...
  m_scene_mouse.set_hover_cursor(m_scenes.get_object_by_name("chair_green"), "pointer");
  m_scene_mouse.set_hover_cursor(m_scenes.get_object_by_name("elevator"), "pointer");
...
function play_cutscene(buffer) {
  ...
  m_cutscene.play_cutscene(container, ["video/section_04.mp4", "video/section_04.webm"], end_cutscene, buffer);//Set Outro here
}
...
function end_cutscene() {
  ...
  setTimeout(function() {
    if (course)
      ...
      window.location = "../mod_1_sec_4_p3/index.html";
  },1500);
}
...
function start_quiz() {
  ...
  m_quiz.add_question({
    set_up: function() {
      ...
      // m_lights.set_light_params (m_scenes.get_object_by_name("alarm_1"),{light_energy: 0});
      // m_lights.set_light_params (m_scenes.get_object_by_name("alarm_2"),{light_energy: 0});
    ...
    check: function() {
      ...
      switch (validationData[1]){
        ...
        s04q01_no.play();
          ...
          question_text.innerHTML =
          //==============================================
          "<strong>This isn't right. Try again.</strong>";
          //==============================================
          $('.balance-text').balanceText();
        ...
        s04q01_lift.play();
          ...
          question_text.innerHTML =
          //==============================================
          "<strong>Lifts aren't safe use in the event of a fire. Try again.</strong>";
          //==============================================
          $('.balance-text').balanceText();
...
function GetHint(){
  ...
  case "noti_icons_0":
    GiveHint("<strong>Wait for the all-clear.</strong>",1000,true);
    break;
  case "noti_icons_1":
    GiveHint("<strong>Find the nearest lift.</strong>",1000,true);
    break;
  case "noti_icons_2":
...
b4w.require("section_04_p2").init();
